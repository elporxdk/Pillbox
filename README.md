...
el repositorio. Dos matices que respeta: **no da códigos de estudiante** —y ya ni
siquiera existen en el repositorio, así que no hay nada que dar—, y si cita el peso
del plano aclara que es el calculado por el CAD y no una medición del prototipo.

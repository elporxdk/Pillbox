...
export default function NotFoundPage() {
  return (
    <div className="min-h-screen bg-[#F4FAFB] flex items-center justify-center px-6">
      <div className="max-w-2xl w-full text-center">
        ...
        {/* 404 Number */}
        <div className="mb-6">
          <h1 className="text-9xl font-extrabold text-[#0A3D5C]/10">404</h1>
        </div>

        {/* Error Message */}
        <h2 className="text-3xl lg:text-4xl font-extrabold text-[#0A3D5C] mb-4">
          Página no encontrada
        </h2>
        <p className="text-lg text-[#0A3D5C]/60 mb-8 max-w-md mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            to="/"
            className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-[#01BAEF] to-[#0B4F6C] text-white font-bold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-white text-[#0A3D5C] font-bold border border-[#0A3D5C]/10 shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all"
          >
        ...
        {/* Helpful Links */}
        <div className="mt-12 pt-8 border-t border-[#0A3D5C]/10">
          <p className="text-sm text-[#0A3D5C]/50 mb-4">Quizás estabas buscando:</p>
          <div className="flex flex-wrap gap-3 justify-center">
            <Link
              to="/"
              className="px-4 py-2 rounded-full bg-[#0A3D5C]/5 text-[#0A3D5C] text-sm font-medium hover:bg-[#0A3D5C]/10 transition-colors"
            >
              Inicio
            </Link>
            <Link
        ...
        <div className="mt-12 flex justify-center">
          <div className="flex items-center gap-2 text-[#0A3D5C]/30">
